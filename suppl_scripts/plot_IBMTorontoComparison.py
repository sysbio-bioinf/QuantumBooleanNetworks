...
#Plot Figure IBMTorontoComparison comparing the results of a single state transition in the network of Giacomantonio et al.
...
uniformDistribution = pickle.load(open("./IBMTorontoComparison/uniformDistribution_5qubits.pkl", "rb"))
...
#pickle.dump(Noiseless_1kshots, open("./IBMTorontoComparison/Noiseless_1kshots.pkl", "wb"))
Noiseless_1kshots = pickle.load(open("./IBMTorontoComparison/Noiseless_1kshots.pkl", "rb"))

#Real IBMQ Toronto QPU + dynamical decoupling + readout error mitigation:
Toronto_dd_mitigated = pickle.load(open("./IBMTorontoComparison/Toronto_dd_mitigated.pkl", "rb"))

#Real IBMQ Toronto, unmitigated:
Toronto_nodd_nomitigation = pickle.load(open("./IBMTorontoComparison/Toronto_nodd_nomitigation.pkl", "rb"))
...
MockBackend_NoisyFakeToronto = pickle.load(open("./IBMTorontoComparison/MockBackend_NoisyFakeToronto.pkl", "rb"))
...
plot_margin = 0.25
plt.tight_layout()
plt.savefig('./IBMTorontoComparison/IBMTorontoComparison.pdf', dpi=350)
